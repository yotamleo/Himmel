...
echo "  Claude Code can auto-capture each session as a note in this vault via"
echo "  the end-session-wiki SessionEnd hook. To point capture at THIS vault,"
echo "  set in your shell profile / code-repo .env:"
echo ""
echo "       LUNA_VAULT_PATH=$REPO_ROOT"
echo ""
echo "  or run /end-session-wiki-setup from your code repo to set it for you."
echo ""
