...
Write-Host "  Claude Code can auto-capture each session as a note in this vault via"
Write-Host "  the end-session-wiki SessionEnd hook. To point capture at THIS vault,"
Write-Host "  set in your shell profile / code-repo .env:"
Write-Host ""
Write-Host "       LUNA_VAULT_PATH=$RepoRoot"
Write-Host ""
Write-Host "  or run /end-session-wiki-setup from your code repo to set it for you."
Write-Host ""
