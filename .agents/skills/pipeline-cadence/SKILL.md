...
When the user asks to arm/inspect/remove the clip-pipeline cadence, run:
    ...
    bash scripts/luna/pipeline-cadence.sh arm|status|disarm [--harvest-time HH:MM] [--synth-time HH:MM] [--health-time HH:MM] [--harvest-model M] [--synth-model M] [--health-model M] [--vault PATH] [--force] [--dry-run]
