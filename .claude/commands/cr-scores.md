...
1. Present the all-time and windowed per-model table (columns: total findings, agreed % — `fixed` verdicts count as agreed, disproved %, conflict count, unaddressed count, availability %).
