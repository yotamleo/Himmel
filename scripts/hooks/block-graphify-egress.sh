...
# unchanged.
CMDPOS='(^|[|;&(`])[[:space:]]*(('"$ASSIGN"'|'"$EXEPFX"'(sudo([[:space:]]+-[^[:space:]]+([[:space:]]+[^-[:space:]][^[:space:]]*)?)*|setsid([[:space:]]+-[^[:space:]]+)*|stdbuf([[:space:]]+-[^[:space:]]+([[:space:]]+[^-[:space:]][^[:space:]]*)?)*|env([[:space:]]+(-[^[:space:]]+([[:space:]]+[^-[:space:]][^[:space:]]*)?|'"$ASSIGN"'))*|timeout([[:space:]]+(-[^[:space:]]+([[:space:]]+[^-[:space:]][^[:space:]]*)?))*[[:space:]]+[^-[:space:]][^[:space:]]*|nice([[:space:]]+(-n[[:space:]]+[^-[:space:]][^[:space:]]*|--a[a-z-]*[[:space:]]+[^-[:space:]][^[:space:]]*|-[^[:space:]]+))*|time([[:space:]]+(-[of][[:space:]]+[^-[:space:]][^[:space:]]*|--o[a-z-]*[[:space:]]+[^-[:space:]][^[:space:]]*|--f[a-z-]*[[:space:]]+[^-[:space:]][^[:space:]]*|-[^[:space:]]+))*|exec([[:space:]]+(-a[[:space:]]+[^-[:space:]][^[:space:]]*|-[^[:space:]]+))*|command([[:space:]]+-[^[:space:]]+)*|nohup([[:space:]]+--)?|builtin|cmd(\.exe)?([[:space:]]+/[[:alnum:]]+(:[[:alnum:]]+)?)*[[:space:]]+/c|(powershell|pwsh)(\.exe)?([[:space:]]+-[^[:space:]]+)*[[:space:]]+-c[[:alnum:]]*))[[:space:]]+)*'"$EXEPFX"
