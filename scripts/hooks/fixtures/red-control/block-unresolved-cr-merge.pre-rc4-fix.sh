...
# 6fe4ad205612f59c71c8354ff9f5981c5d23bb5f (round-3-shipped, the
# `command -v go_gate` version, pre HIMMEL-3142 round 4's unset+declare-F
# fix). That commit's PR branch was deleted on squash-merge; the blob is
# unreachable from a fresh clone of origin. Captured here from a local
# object store that still had it loose (HIMMEL-3154). Used by
# test-block-unresolved-cr-merge.sh's RED controls (labels
# HIMMEL-3142-RC4A-RC and HIMMEL-3142-RC4B-RC).
# ---
