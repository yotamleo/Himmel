...
# 6749462a6c22911d748b8a39254fbd86bdf14ece (round-2-shipped, pre `go_rc=127`
# fix, HIMMEL-3142 round 3). That commit's PR branch was deleted on
# squash-merge; the blob is unreachable from a fresh clone of origin.
# Captured here from a local object store that still had it loose
# (HIMMEL-3154). Used by test-block-unresolved-cr-merge.sh's RED control
# (label HIMMEL-3142-RC127-RC).
# ---
