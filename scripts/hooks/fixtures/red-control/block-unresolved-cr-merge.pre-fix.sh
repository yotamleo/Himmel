...
# 6ac483e4ad49d66e5760a2ea632871bcab029576 (HIMMEL-3143; still a reachable
# main ancestor, unlike the other fixtures in this directory). Committed
# statically, not `git show <sha>`'d at test time, for consistency with the
# other frozen mutants here. Used by test-block-unresolved-cr-merge.sh's
# RED control (label HIMMEL-3142-RC).
# ---
