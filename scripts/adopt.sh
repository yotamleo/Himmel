...
#            into <target>/.claude/settings.json, place git gates, then install
#            plugins --scope project.
#   user     Wire ~/.claude/settings.json hooks to reference THIS himmel clone,
#            place git gates, then install plugins --scope user (native Git
#            gates are copied).
#
# Flags:
