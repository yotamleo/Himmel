...
Check 'quoted --cwd preserves spaces'   ((Get-BrokerCwd -CommandLine 'node broker.mjs --cwd="C:\Users\Example User\repo"') -eq 'C:\Users\Example User\repo') # leak-allow: home-path test fixture
