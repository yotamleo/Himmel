...
export const syntheticRuns = [
  { run_id: 'T1-luna-1', task: 'T1', cell: 'luna', rep: 1, model: 'gpt-6-luna', effort: 'high', prompt_sha256: 'hT1', verdict: 'pass', duration_ms: 100, out_of_scope_paths: [] },
  { run_id: 'T1-luna-2', task: 'T1', cell: 'luna', rep: 2, model: 'gpt-6-luna', effort: 'high', prompt_sha256: 'hT1', verdict: 'pass', duration_ms: 110, out_of_scope_paths: [] },
  ...
  { run_id: 'T7-luna-1', task: 'T7', cell: 'luna', rep: 1, model: 'gpt-6-luna', effort: 'high', prompt_sha256: 'hT7', verdict: 'pass', duration_ms: 200, out_of_scope_paths: [] },
  { run_id: 'T7-luna-2', task: 'T7', cell: 'luna', rep: 2, model: 'gpt-6-luna', effort: 'high', prompt_sha256: 'hT7', verdict: 'fail', duration_ms: 210, out_of_scope_paths: [] },
  ...
  { run_id: 'T10-luna-1', task: 'T10', cell: 'luna', rep: 1, model: 'gpt-6-luna', effort: 'high', prompt_sha256: 'hT10', verdict: 'fail', duration_ms: 300, out_of_scope_paths: [] },
  { run_id: 'T10-luna-2', task: 'T10', cell: 'luna', rep: 2, model: 'gpt-6-luna', effort: 'high', prompt_sha256: 'hT10', verdict: 'fail', duration_ms: 310, out_of_scope_paths: [] },
...
export function syntheticTokenRows() {
  ...
  map.set('T7-luna-1', { usage: lunaUsage, cost_usd: costUsd('gpt-6-luna', lunaUsage) });
