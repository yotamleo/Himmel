...
# HIMMEL-2743: archive/ never ships. Snapshot-preserved public copies have
# independent content; private still checks them like every other tracked twin.
SNAPSHOT_PRESERVED_PS1=(scripts/gen-changelog.ps1)
PUBLIC_PROJECTION=0
