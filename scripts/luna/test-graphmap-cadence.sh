...
assert_contains "luna runner stamps the format version (HIMMEL-588)"   "# himmel-cadence-runner-format: 7" "$luna_sh"
assert_contains "himmel runner stamps the format version (HIMMEL-588)" "# himmel-cadence-runner-format: 7" "$himmel_sh"
...
assert_contains "luna bat stamps the format version (HIMMEL-588)"   "rem himmel-cadence-runner-format: 7" "$luna_bat"
assert_contains "himmel bat stamps the format version (HIMMEL-588)" "rem himmel-cadence-runner-format: 7" "$himmel_bat"
