...
| `claude-obsidian` (AgriciDaniel, vendored via yotamleo fork) | [yotamleo/claude-obsidian](https://github.com/yotamleo/claude-obsidian) (fork of [AgriciDaniel/claude-obsidian](https://github.com/AgriciDaniel/claude-obsidian)) @ tag `v1.9.2-himmel.2` in himmel marketplace.json | `/plugin install claude-obsidian` from himmel marketplace | `wiki-query` optionally powers richer Phase 4 Related Notes traversal. Optional. *(LUNA-4 vendor fork — attribution + prompt-hook fix; LOGIC stays in himmel.)* |
