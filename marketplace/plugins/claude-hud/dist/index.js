...
export async function main(overrides = {}) {
    ...
    try {
        ...
        const customLineCommand = config.display.customLineCommand;
        const customLines = shouldRunCustomLine(customLineCommand)
            ? await deps.runCustomLineCommand(customLineCommand, JSON.stringify(stdin), {
                cwd: stdin.cwd,
            })
            : null;
...
export function shouldRunCacheEconomicsRefresh(argv = process.argv) {
