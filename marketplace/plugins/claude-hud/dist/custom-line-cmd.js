...
export function shouldRunCustomLine(cmd, env = process.env) {
    return Boolean(cmd) && isExtraCmdAllowed(env);
}
export async function runCustomLineCommand(cmd, stdinJson, opts = {}) {
...
//# sourceMappingURL=custom-line-cmd.js.map